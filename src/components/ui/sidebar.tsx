  ...
  "group/menu-button flex w-full items-center justify-start gap-2 whitespace-nowrap rounded-md p-2 text-left text-sm font-medium outline-none ring-sidebar-ring transition-colors disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 [&>svg]:size-4 [&>svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        sidebar:
          "bg-transparent text-sidebar-foreground/70 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground active:bg-sidebar-accent active:text-sidebar-accent-foreground data-[active=true]:bg-sidebar-accent data-[active=true]:text-sidebar-primary data-[active=true]:[&>svg]:text-sidebar-primary",
      },
      size: {
        default: "h-9",
        sm: "h-8",
    ...
    return (
      <Tooltip>
        ...
        <TooltipContent
          side="right"
          align="center"
          hidden={(state !== "collapsed" && !isMobile) || (isMobile && typeof tooltip === 'undefined')}
          {...tooltip}
        />
      </Tooltip>
    )
