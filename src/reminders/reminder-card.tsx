  ...
  return (
    <Card className={cn(
      ...
      <CardContent className="space-y-2">
        <div className={cn("text-3xl font-bold flex items-baseline gap-1", isOverdue && "text-destructive")}>
            <DhiramSymbol className={cn("text-2xl", !isOverdue && "text-muted-foreground")} />
